...
public class TreinadorModel {
	...
	public int autenticacao(String email, String senha){
		...
		Cursor c = db.rawQuery("SELECT id, email, senha FROM treinadores " +
	...
	public ContentValues selectUser(String id){
		...
		Cursor c = db.rawQuery("SELECT id, nome, email, sexo, data_nascimento FROM treinadores " +
	...
	public boolean checkUserByEmail(String email){
		...
		Cursor c = db.rawQuery("SELECT id FROM treinadores " +
	...
	public ArrayList<Usuario> selectAllProfessoresToSync() {
		...
		Cursor c = db.rawQuery("SELECT * FROM treinadores " +
